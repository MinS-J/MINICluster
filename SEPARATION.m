...
figure;
hold on;
plot(x, clusterdist1/150,'Color', 'k', 'Marker','o','MarkerSize',3);
plot(x, clusterdist2/150,'Color', 'r', 'Marker','o','MarkerSize',3);
plot(x, clusterdist3/150,'Color', 'g', 'Marker','o','MarkerSize',3);
plot(x, clusterdist4/150,'Color', 'b', 'Marker','o','MarkerSize',3);
hold off;
ticks = 1:K;
xticks(ticks)
xlim([0 K+1])
...
xlabel("Cluster")
ylabel("Frequency (/s)")
legend("Condition1 DR", "Condition2 DR", "Condition1 MR", "Condition2 MR")
end